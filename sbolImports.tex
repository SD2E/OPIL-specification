...
For example, a \sbol{CombinatorialDerivation} can be used to specify an experiment that tests the growth of one of a number of  different strains on various different carbon sources at various different temperatures without having to specify a \sbol{Component} for every possible combination of strain, carbon source, and temperature in the experiment.
